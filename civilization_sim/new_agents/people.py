    ...
    def attack_enemy(self):
        ...
        for enemy in enemies:
            ...
            if hasattr(self.model, "wars") and war_key in self.model.wars:
                ...
                logging.info(f"{self.profession} {self.unique_id} (Tribe {self.tribe_id}) attacked Enemy {enemy.unique_id} at {enemy.pos}")
                
                if enemy.energy <= 0:
                    logging.info(f"Enemy {enemy.unique_id} killed by {self.profession} {self.unique_id}")
